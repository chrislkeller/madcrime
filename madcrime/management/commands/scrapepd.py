                    ...
                    for item in rowsDetails:
                        ...
                        if models.has_key('Details'):
                            ...
                            try:
                                ...
                                obj = Incident(dateDetails = convertedDateDetails, dateIncidents = convertedDateIncidents, typeDetails = typeDetails, addressDetails = addressDetails, suspectDetails = suspectDetails, arrestedDetails = arrestedDetails, victimDetails = victimDetails, detailsDetails = detailsDetails[:3000], linkIncidents = linkIncidents, caseIncidents = caseIncidents)
                                obj.save()
